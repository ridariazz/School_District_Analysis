...
In this project, we analyzed the data for every school district to provide visual analysis (Data Frames) for the performance of the students' overall testing performance for math and reading as well as funding for every school mentioned in the dataset. Our school district summary consists of the summzarization of the key metrics:
